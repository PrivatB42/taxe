...
<?php endif; ?>
 ...
 <script>
    ...
    var routeStore = "<?php echo e(route('activites.store')); ?>";
    var routeUpdate = "<?php echo e(route('activites.update', ':id')); ?>";
    var routeToggle = "<?php echo e(route('activites.toggle-active', ':id')); ?>";
...
</script> <?php /**PATH C:\Users\Admin\Downloads\taxe\Modules/Entite\resources/views/components/activite/activite-liste.blade.php ENDPATH**/ ?>