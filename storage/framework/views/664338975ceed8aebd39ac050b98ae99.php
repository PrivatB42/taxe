...
<?php endif; ?>
 ...
 <script>
    ...
    var routeStore = "<?php echo e(route('taxes.store')); ?>";
    var routeUpdate = "<?php echo e(route('taxes.update', ':id')); ?>";
    var routeToggle = "<?php echo e(route('taxes.toggle-active', ':id')); ?>";
...
</script> <?php /**PATH C:\Users\Admin\Downloads\taxe\Modules/Entite\resources/views/components/taxe/taxe-liste.blade.php ENDPATH**/ ?>