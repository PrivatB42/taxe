...
<?php endif; ?>
 ...
 <script>
    ...
    var routeStore = "<?php echo e(route('contribuables-activites.store')); ?>";
    var routeUpdate = "<?php echo e(route('contribuables-activites.update', ':id')); ?>";
    var routeToggle = "<?php echo e(route('contribuables-activites.toggle-active', ':id')); ?>";
    ...
    function arrayButtons(data, type, row, meta) {
        const route = "<?php echo e(route('contribuables.show', ['matricule' => $contribuable->matricule, 'action' => ':action', 'contribuable_activite_id' => ':id'])); ?>".replace(':id', row.id);
        return `
...
</script> <?php /**PATH C:\Users\Admin\Downloads\taxe\Modules/User\resources/views/components/contribuable-activite/contribuable-activite-liste.blade.php ENDPATH**/ ?>