...
<body>
    ...
    <div class="brand-panel">
        <div class="brand-content">
            ...
            <h1 class="brand-title"><?php echo e(config('app.name', 'Gestion Taxes')); ?></h1>
        ...
        <form method="POST" action="<?php echo e(route('login.post')); ?>" id="loginForm">
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    <input type="text" 
                           name="identifiant" 
                           class="form-control <?php $__errorArgs = ['identifiant'];
...
unset($__errorArgs, $__bag); ?>" 
                           ...
                           value="<?php echo e(old('identifiant')); ?>"
...
<?php /**PATH C:\Users\Admin\Downloads\taxe\Modules/Auth\resources/views/login.blade.php ENDPATH**/ ?>