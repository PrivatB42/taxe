...
<?php endif; ?>
 ...
 <script>
    ...
    var routeStore = "<?php echo e(route('gestionnaires.store')); ?>";
    var routeUpdate = "<?php echo e(route('gestionnaires.update', ':id')); ?>";
    var routeToggle = "<?php echo e(route('gestionnaires.toggle-active', ':id')); ?>";
...
</script> <?php /**PATH C:\Users\Admin\Downloads\taxe\Modules/User\resources/views/components/gestionnaire/gestionnaire-liste.blade.php ENDPATH**/ ?>