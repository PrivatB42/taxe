...
$config = [
'tableId' => 'table-id',
'ajaxUrl' => route('activites-taxes.data'),
'lengthChange' => false,
'buttons' => [],
];
...
<x-generic.card>
 ...
 <script>
    ...
    var routeStore = "{{ route('activites-taxes.store') }}";
    var routeUpdate = "{{ route('activites-taxes.update', ':id') }}";
    var routeToggle = "{{ route('activites-taxes.toggle-active', ':id') }}";
